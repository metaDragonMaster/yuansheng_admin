...
api.setShopAliveById = function(shopId) {
	return request({
		url: `/manage/ncq/shop/active/${shopId}`,
		method: 'put',
	})
}
// 添加店铺
...
api.setShopFrost = function(shopId) {
	return request({
		url: `/manage/ncq/shop/frost/${shopId}`,
		method: 'put',
	})
}
// 删除店铺
api.deleteShop = function(shopId) {
	return request({
		url: `/manage/ncq/shop/delete/${shopId}`,
		method: 'delete',
	})
}
//查询店铺列表
